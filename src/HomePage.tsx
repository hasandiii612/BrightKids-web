                ...
                <div className="container mx-auto px-6 py-3">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            <img src="/BrightKids-web/Logo.png" alt="BrightKids Logo" className="w-full max-w-40 h-auto transition-all hover:scale-110"/>
                        </div>
                ...
                <div className="container mx-auto px-6 py-20 md:py-28 flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div
                        ...
                        <div className="relative">
                            ...
                            <img src="/BrightKids-web/HeroAnimal4.jpeg" alt="Hero Animation"
                    ...
                    <div className="grid gap-12 md:grid-cols-2 items-center">
                        ...
                        <div className="order-1 md:order-2">
                            <div className="relative">
                                ...
                                <img src="/BrightKids-web/HeroSpace.jpeg" alt="Adventure" className="relative w-full rounded-lg shadow-lg" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="container mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="mb-6 md:mb-0">
                            <img src="/BrightKids-web/Logo.png" alt="BrightKids Logo" className="h-20" />
